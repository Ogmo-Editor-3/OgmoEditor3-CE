...
class PropertyDisplayDropdown
{
    ...
    public function signal(dropdown:StickerDropdown)
    {
        ...
        else
        {
            ...
            dropdown.addSlider("Font Size", 0, 200, Math.round(settings.fontSize * 100.0), onChangeFontSize, "Scales font for property display");
    ...
    {
        settings.fontSize = Math.max(1, percent) / 100.0;
        EDITOR.dirty();
    }
